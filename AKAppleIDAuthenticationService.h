...
#import "AKAppleIDAuthenticationDaemonProtocol.h"
#import "AKPiggybackRequestingControllerDelegate.h"

@class AKAccountManager, AKAuthenticationTrafficController, AKAuthenticationUILiaison, AKClient, NSObject<AKAppleIDAuthSupportProxy>, NSString;

@interface AKAppleIDAuthenticationService : NSObject <AKPiggybackRequestingControllerDelegate, AKAppleIDAuthenticationDaemonProtocol>
{
    AKClient *_client;
...
- (id)_postBodyForiCSCServerUIResponseWithInfo:(id)arg1 andError:(id)arg2;
- (id)_requestForRecoveryCompletionWithInfo:(id)arg1 recoveredInfo:(id)arg2 context:(id)arg3 error:(id)arg4;
- (id)_decorateIDMSSuppliedRecoveryMetadata:(id)arg1 error:(id *)arg2;
- (_Bool)_shouldSendServerResponseForRecoveredInfo:(id)arg1 withRecoveryError:(id)arg2;
- (void)_retrieveEscrowedRecoveryDataForContext:(id)arg1 initialAuthResponse:(id)arg2 recoveryInfo:(id)arg3 completion:(CDUnknownBlockType)arg4;
- (_Bool)_isServerUIRequestingNativeICSCRecovery:(id)arg1;
- (void)_showServerUIWithURLRequest:(id)arg1 context:(id)arg2 initialAuthResponse:(id)arg3 loadDelegate:(id)arg4 completion:(CDUnknownBlockType)arg5;
...
- (void)_handleBasicLoginUICompletionWithUsername:(id)arg1 password:(id)arg2 context:(id)arg3 additionalData:(id)arg4 collectionError:(id)arg5 attemptIndex:(unsigned long long)arg6 completion:(CDUnknownBlockType)arg7;
...
- (void)_authKitAccountForContext:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)_accountForSilentServiceTokenAuthWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)renewRecoveryTokenForICSCIdentityToken:(id)arg1 forAltDSID:(id)arg2 completion:(CDUnknownBlockType)arg3;
